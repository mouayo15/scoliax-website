        ...
        <div className="lg:col-span-3">
          ...
          >
            ...
            <div
              ...
              style={{ background: "#0F0D0B", border: "1px solid rgba(250,250,248,0.08)" }}
            >
        ...
        <div className="lg:col-span-3">
          ...
          >
            ...
            <div className="relative my-2">
              ...
              />
              <div
                className="rounded-full flex items-center justify-center spin-slow"
                style={{
                  width: 60,
                  height: 60,
      ...
      <div className="card-surface p-7 lg:p-10 h-full" style={{ borderRadius: 20 }} data-testid="feature-channels">
        ...
        <div className="relative mt-10 pb-3 overflow-x-auto">
          ...
          <div
            ...
            style={{ left: "calc(50% + 18px)", width: 2, background: "var(--orange)", opacity: 0.6 }}
          />
          <div className="flex items-center justify-between min-w-[600px] relative">
            {platforms.map((p, i) => (
              <div key={p.name} className="flex flex-col items-center gap-3" style={{ width: 70 }}>
                <div
                  className="rounded-full flex items-center justify-center"
                  style={{ width: 36, height: 36, background: p.color }}
                >
                  {p.icon}
                </div>
                <div
                  className="rounded-md px-2 py-2 w-full text-center"
                  style={{
                    background: "rgba(15,13,11,0.6)",
                    border: i === 3 ? "1px solid var(--orange)" : "1px solid rgba(250,250,248,0.06)",
                  }}
                >
      ...
      <div className="mt-9 grid lg:grid-cols-12 gap-4 items-center">
        ...
        <div className="lg:col-span-2 flex flex-col items-center justify-center gap-2 py-4">
          <div
            ...
            style={{ width: "100%", height: 2, background: "var(--orange)" }}
          />
          <div
    ...
    <div className="card-surface p-7 lg:p-10 h-full" style={{ borderRadius: 20 }} data-testid="feature-studio">
      ...
      <div className="mt-9 grid lg:grid-cols-2 gap-5">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <select
              ...
              defaultValue="long"
              data-testid="post-format-select"
            >
          ...
          <div className="text-sm leading-relaxed" style={{ color: "var(--text)" }}>
            Aujourd'hui, on lance une nouvelle façon de faire vivre votre marque sur les
            réseaux sociaux<span className="caret" style={{ color: "var(--orange)" }}>|</span>
          </div>
          <div className="mt-6 flex items-center justify-between">
            <div className="muted text-[11px]">142 / 280</div>
            <button
              className="btn-orange rounded-full px-4 py-2 text-xs font-medium inline-flex items-center gap-2"
        ...
        <div
          ...
          style={{
            background: "linear-gradient(180deg, rgba(24,20,16,0.95), rgba(15,13,11,0.7))",
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-3">
            <div
              ...
              style={{ width: 34, height: 34, background: "linear-gradient(135deg, #D4720A, #B35F08)" }}
            />
            <div>
    ...
    <FadeIn className="h-full">
      <div className="card-surface p-7 lg:p-10 h-full" style={{ borderRadius: 20 }} data-testid="feature-analytics">
        ...
        <div className="mt-9 grid lg:grid-cols-12 gap-5">
          <div
            className="lg:col-span-7 rounded-xl p-5"
            style={{ background: "#0F0D0B", border: "1px solid rgba(250,250,248,0.06)" }}
          >
            <div className="flex items-center justify-between mb-4">
          ...
          <div className="lg:col-span-5 grid grid-rows-3 gap-3">
            {[
              { v: "28+", l: "canaux connectés", icon: <Globe size={16} /> },
              { v: "10 K+", l: "posts générés", icon: <PenLine size={16} /> },
              { v: "4,2×", l: "engagement moyen", icon: <TrendingUp size={16} /> },
            ].map((s, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div>
                  <div className="text-2xl font-bold" style={{ color: "var(--text)" }}>{s.v}</div>
                  <div className="text-[11px] muted">{s.l}</div>
                </div>
              </div>
            ))}
          </div>
